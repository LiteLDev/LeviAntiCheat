...
- Added service check to avoid unexpected conditions

## [0.16.0] - 2026-09-14

### Changed

- Adapted to LeviLamina 26.40.*
- Reworked AntiXray @KawaiiNahida

## [0.15.0] - 2026-09-06

### Changed

- Removed AntiToolbox, CrafterCrashFix, InfiniteBlockFix, IllegalMovementCheck, and LoginFloodCheck
...
- Added anti bad TextPacket @Milvona
...
- Removed `IllegallyTradeCheck`

## [0.13.3] - 2026-05-17

### Fixed

- Fixed configuration file version
...
- Tried to fix a crash issue of AntiXray

## [0.12.2] - 2026-02-03

### Changed

- Modified hook priority of SubChunkRequestPacket to highest

## [0.12.1] - 2026-02-03

### Added

- Enhanced AntiBadPacket
...
[Unreleased]: https://github.com/LiteLDev/LeviAntiCheat/compare/v0.17.0...HEAD
...
[0.16.0]: https://github.com/LiteLDev/LeviAntiCheat/compare/v0.15.0...v0.16.0
[0.15.0]: https://github.com/LiteLDev/LeviAntiCheat/compare/v0.14.2...v0.15.0
[0.14.2]: https://github.com/LiteLDev/LeviAntiCheat/compare/v0.14.1...v0.14.2
...
[0.12.1]: https://github.com/LiteLDev/LeviAntiCheat/compare/v0.12.0...v0.12.1
[0.12.0]: https://github.com/LiteLDev/LeviAntiCheat/compare/v0.11.0...v0.12.0
